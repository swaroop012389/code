/** Program Description: Asserting moratorium warning message for NC State
 *  Author			   : Pavan mule
...
public class TC034 extends AbstractCommercialTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/commercial/retailRegression/NBTCID034.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.addInfo("Scenario 01", "Asserting Moratorium warning message on request bind page ");
			Assertions.verify(
			...
			// Asserting mortorium message on bind approval page"A moratorium is in effect
			...
			Assertions.addInfo("Scenario 02",
					"Asserting Moratorium warning message on request bind page while approving referral");
			...
			Assertions.addInfo("Scenario 03",
					"Asserting Moratorium warning message on renewal re quote referral page while approving referral");
			...
			Assertions.failTest("Commercial Retail TC034 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("Commercial Retail TC034 ", "Executed Successfully");
			}
		}
	}
}
