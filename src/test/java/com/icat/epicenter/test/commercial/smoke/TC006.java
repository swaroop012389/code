/** Program Description: Create a Retail GL Quote with single location and single building by entering all the details in building page
...
public class TC006 extends AbstractCommercialTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/commercial/smoke/NBTCID06.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setupData) {
		...
		priorLossesPage.cancelButton.waitTillVisibilityOfElement(60);
		Assertions.verify(priorLossesPage.cancelButton.checkIfElementIsDisplayed(), true, "Prior Loss Page",
				"Prior Loss Page Loaded successfully", false, false);
		...
		// Signing out
		Assertions.passTest("Commercial Smoke Test Case 06 - Retail GL", "Executed Successfully");
