/** Program Description: Create Endorse NPB and Change Additional Interest Information
...
public class TC059 extends AbstractCommercialTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/commercial/wholesaleRegression/NBTCID059.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		EndorseAdditionalInterestsPage endorseAdditionalInterestPage = new EndorseAdditionalInterestsPage();
		...
		try {
			...
			// endorse policy
			Assertions.addInfo("Policy Summary Page", "Initiate Endorsement to change Additional Interest Details");
			...
			endorsePolicyPage.changeAIInformationLink.waitTillVisibilityOfElement(60);
			...
			Assertions.verify(endorseAdditionalInterestPage.okButton.checkIfElementIsDisplayed(), true,
					"Endorse Additional Interest Page", "Endorse Additional Interest Page loaded successfully", false,
					false);
			endorseAdditionalInterestPage.enterEndorsementAdditionalInterestDetails(testData);
			Assertions.passTest("Endorse Additional Interest Page", "Additional Interest details updated successfully");
			...
			Assertions.failTest("Commercial NBRegression Test Case 59", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("Commercial NBRegression Test Case 59", "Executed Successfully");
			}
		}
	}
}
