/** Program Description: Create Endorse NPB and update Producer Contact
...
public class TC060 extends AbstractCommercialTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/commercial/wholesaleRegression/NBTCID060.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		EndorseProducerContact endorseProducerContactPage = new EndorseProducerContact();
		...
		try {
			...
			// endorse policy
			Assertions.addInfo("Policy Summary Page", "Initiate Endorsement to change Producer Contact Details");
			...
			// clicking on producer contact hyperlink
			...
			// modifying producer contact Details
			testData = data.get(dataValue2);
			Assertions.verify(endorseProducerContactPage.okButton.checkIfElementIsDisplayed(), true,
					"Endorse Producer Contact Page", "Endorse Producer Contact Page loaded successfully", false, false);
			endorseProducerContactPage.enterEndorseProducerContactDetails(testData);
			Assertions.passTest("Endorse Producer Contact Page", "Producer Contact details modified successfully");
			...
			Assertions.failTest("Commercial NBRegression Test Case 60", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("Commercial NBRegression Test Case 60", "Executed Successfully");
			}
		}
	}
}
