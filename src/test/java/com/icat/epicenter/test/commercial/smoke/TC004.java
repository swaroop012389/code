/** Program Description: Create a wholesale wind Quote with multi location and add one building for each location by entering all the details in building page
...
public class TC004 extends AbstractCommercialTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/commercial/smoke/NBTCID04.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setupData) {
		...
		// Signing out
		Assertions.passTest("Commercial Smoke Test Case 04 - Wholesale Wind", "Executed Successfully");
