/** Program Description: To check that the USM is able to cancel the policy with an ICAT initiated Reason.
...
public class PNBTC010 extends AbstractNAHOTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/hiho/regression/HIHOPNB/PNBTCID10.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		Assertions.passTest("PNB_Regression_TC010", "Executed Successfully");
		System.out.println("PNB Regression TC010 Ended");
