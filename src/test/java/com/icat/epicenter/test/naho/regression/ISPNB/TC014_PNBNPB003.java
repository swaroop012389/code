...
public class TC014_PNBNPB003 extends AbstractNAHOTest {

	public TC014_PNBNPB003() {
		super(LoginType.NAHOPRODUCER);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBNPB003.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.passTest("Endorse Policy Page", "Clicked on Change Additional Interests Information link");
			...
			// Asserting the Added AI from Endorse Summmary Page
			...
			String aiAdded = endorsePolicyPage.endorsementSummary.formatDynamicPath(7).getData();
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(5).checkIfElementIsDisplayed(),
					...
					"The Added Additional Interest is " + aiAdded + " displayed is verified", false, false);

			// Click On Submit Button
			endorsePolicyPage.submitButton.scrollToElement();
			endorsePolicyPage.submitButton.click();

			// Asserting the Referral Message For Additional Insured and
			// Relationship is Corporation
			...
			Assertions.verify(referQuotePage.aiReferralMessage.checkIfElementIsDisplayed(), true, "Refer Quote Page",
					"The Referral Message displayed for the AI type Additional Insured and Relationship is Corporation is "
							+ referQuotePage.aiReferralMessage.getData() + " displayed is verified",
					false, false);
			...
			Assertions.failTest("PNBTC014 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC014 ", "Executed Successfully");
			}
		}
	}
