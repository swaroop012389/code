...
public class TC027_NBRE020 extends AbstractNAHOTest {

	public TC027_NBRE020() {
		super(LoginType.NAHOPRODUCER);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBRE020.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.failTest("NBTC027 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC027 ", "Executed Successfully");
			}
		}
	}
}