...
public class TC007_PNBPB007 extends AbstractNAHOTest {

	public TC007_PNBPB007() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBPB007.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Assert deductibles update in endorse summary page
			...
			Assertions.verify(
					...
					"Named Storm value is updated to " + endorseSummaryDetailsPage.endorsementsValues
			...
			Assertions.failTest("PNBTC007 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC007 ", "Executed Successfully");
			}
		}
	}
}
