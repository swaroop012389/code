...
public class TC021_PNBD002 extends AbstractNAHOTest {

	public TC021_PNBD002() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBD002.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.passTest("Create Quote Page",
					"Decreased Wind Deductible, AOP Deductible and AOWH Deductible values successfully");
			...
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(5).checkIfElementIsDisplayed(),
					...
					aop + " value decreased From : " + aopOldValue + " To : " + aopNewValue + " and its verified",
					false, false);
			...
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(10).checkIfElementIsDisplayed(),
					true, "Endorse Summary Page", aOWH_Ded + " value decreased From : " + aOWH_Ded_OldValue + " To : "
			...
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(15).checkIfElementIsDisplayed(),
					true, "Endorse Summary Page", namedStorm + " value decreased From : " + namedStormOldValue
			...
			Assertions.failTest("PNBTC021 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC021 ", "Executed Successfully");
			}
		}
	}
}
