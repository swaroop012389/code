...
public class TC012_NBRE005 extends AbstractNAHOTest {

	public TC012_NBRE005() {
		super(LoginType.NAHOPRODUCER);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBRE005.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			while (!bindRequestPage.aiRelationshipMessage.checkIfElementIsPresent()) {
				if (bindRequestPage.aiRelationshipMessage.checkIfElementIsPresent()
						&& bindRequestPage.aiRelationshipMessage.checkIfElementIsDisplayed()) {
					break;
				} else {
			...
			Assertions.verify(bindRequestPage.aiRelationshipMessage.checkIfElementIsDisplayed(), true,
					" Bind Request Page",
					bindRequestPage.aiRelationshipMessage.getData() + " referring to USM is verified", false, false);
			...
			Assertions.failTest("NBTC012 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC012 ", "Executed Successfully");
			}
		}
	}
}