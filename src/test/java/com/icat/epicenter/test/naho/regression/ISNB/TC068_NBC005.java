...
public class TC068_NBC005 extends AbstractNAHOTest {
	...
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBC005.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			if (referQuotePage.referQuote.checkIfElementIsPresent()
				...
				// homePage.searchReferral(quoteNo);
				...
				// Approve Referral
				/*
				 * Assertions.verify(referralPage.pickUp.checkIfElementIsDisplayed() ||
				 * referralPage.approveOrDeclineRequest.checkIfElementIsDisplayed(), true,
			...
			String quoteNumber = accountOverviewPage.quoteNumber.getData().replace("(", "").replace(")", "");
			...
			Assertions.failTest("NBTC068 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC068 ", "Executed Successfully");
			}
		}
	}
}
