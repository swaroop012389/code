...
public class TC016_NBRE009 extends AbstractNAHOTest {

	public TC016_NBRE009() {
		super(LoginType.NAHOPRODUCER);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBRE009.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.verify(homePage.userPreferences.checkIfElementIsDisplayed(), true, "Home Page",
					"User Preferences icon is displayed on Residential producer's Home page is verified", false, false);
			...
			Assertions.verify(homePage.userPreferences.checkIfElementIsDisplayed(), true, "Account Overview Page",
					"User Preferences icon is displayed on Residential producer's Account overview page is verified",
					false, false);
			...
			Assertions.failTest("NBTC016 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC016 ", "Executed Successfully");
			}
		}
	}
}