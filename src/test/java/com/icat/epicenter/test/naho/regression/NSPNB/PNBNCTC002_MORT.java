/** Program Description: Creating Moratorium for NC State,Deleting Moratorium and Verifying Moratorium Warning message
 *  Author			   : Pavan
...
public class PNBNCTC002_MORT extends AbstractNAHOTest {

	public PNBNCTC002_MORT() {
		super(LoginType.ADMIN);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/NSPNB/NC002.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Verifying the moratorium warning message
			...
			Assertions.verify(
					...
					"Moratorium warning message, " + requestBindPage.moratoriumMsg.getData() + " are displayed", false,
					false);
			...
			Assertions.addInfo("Scenario 02", "Asserting Moratorium warning message in Referral page");
			Assertions.verify(
			...
			Assertions.verify(moratoriumPage.deleteLink.checkIfElementIsPresent(), false, "Moratorium Page ",
					"Moratorium for Zipcode " + testData.get("ZipCode") + " is deleted successfully", false, false);
			...
			Assertions.failTest("PNBNCTC002 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBNCTC002 ", "Executed Successfully");
			}
		}
	}
}
