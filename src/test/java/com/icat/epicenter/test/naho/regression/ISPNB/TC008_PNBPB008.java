...
public class TC008_PNBPB008 extends AbstractNAHOTest {

	public TC008_PNBPB008() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBPB008.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.failTest("PNBTC009 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC009 ", "Executed Successfully");
			}
		}
	}
}
