...
public class TC029_PNBC006 extends AbstractNAHOTest {

	public TC029_PNBC006() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBC006.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Click on EditBuilding Information Link
			...
			// Changing the Occupancy type to primary
			Assertions.verify(dwellingPage.reviewDwelling.checkIfElementIsDisplayed(), true, "Dwelling Page",
					"Dwelling Page Loaded successfully", false, false);

			testData = data.get(dataValue2);
			dwellingPage.addDwellingDetails(testData, dataValue2, dataValue2);
			Assertions.passTest("Dwelling Page", "Occupancy Changed from Tenant to Primary successfully");
			...
			// Asserting Ho5 form from create quote page
			...
			Assertions.verify(createQuotePage.formType_HO5.checkIfElementIsPresent(), false, "Create Quote Page",
					"The HO5 form is not present during endorsement is verified", false, false);
			...
			String occupancyfrom = endorsePolicyPage.endorsementSummary.formatDynamicPath(6).getData();
			String occupancyto = endorsePolicyPage.endorsementSummary.formatDynamicPath(7).getData();
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(5).checkIfElementIsDisplayed(),
					...
					"The Occupancy " + occupancyfrom + " changed to : " + occupancyto + " displayed is verified", false,
					false);
			...
			Assertions.failTest("PNBTC029 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC029 ", "Executed Successfully");
			}
		}
	}
