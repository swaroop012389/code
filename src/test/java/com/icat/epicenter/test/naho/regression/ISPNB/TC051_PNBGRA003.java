...
public class TC051_PNBGRA003 extends AbstractNAHOTest {

	public TC051_PNBGRA003() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBGRA003.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Asserting the Changed Cov F Value From Endorse Summary Page
			...
			String covFfrom = endorsePolicyPage.endorsementSummary.formatDynamicPath(6).getData();
			String covFto = endorsePolicyPage.endorsementSummary.formatDynamicPath(7).getData();
			...
			Assertions.failTest("PNBTC051 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC051 ", "Executed Successfully");
			}
		}
	}
