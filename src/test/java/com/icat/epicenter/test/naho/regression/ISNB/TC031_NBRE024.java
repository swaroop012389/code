...
public class TC031_NBRE024 extends AbstractNAHOTest {

	public TC031_NBRE024() {
		super(LoginType.NAHOPRODUCER);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBRE024.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Validating the referral Message for prior losses
			Assertions.verify(referQuotePage.constructionClassOtherReferralMessage.checkIfElementIsDisplayed(), true,
					"Refer Quote Page",
					"Referral Message for Construction Class : "
							+ referQuotePage.constructionClassOtherReferralMessage.getData() + " is displayed",
					false, false);
			...
			Assertions.failTest("NBTC031 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC031 ", "Executed Successfully");
			}
		}
	}
}
