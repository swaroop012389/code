/** Program Description: Creating Moratorium for NJ State,Deleting Moratorium and Verifying Moratorium Warning message
 *  Author			   : Pavan
...
public class PNBNJTC002_MORT extends AbstractNAHOTest {

	public PNBNJTC002_MORT() {
		super(LoginType.ADMIN);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/NSPNB/NJ002.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.failTest("PNBNJTC002 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBNJTC002 ", "Executed Successfully");
			}
		}
	}
}
