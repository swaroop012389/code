...
public class TC082_NBGEN013 extends AbstractNAHOTest {

	public TC082_NBGEN013() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISNB/NBGEN013.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.passTest("Request Bind Page", "The Quote Number is " + quoteNumber);
			...
			// Asserting Renovated roof included
			Assertions.verify(viewPolicySnapShot.renovatedHome.getData().contains("Included"), true,
					"View Policy Snapshot", "Renovated Home discount is included", false, false);
			...
			Assertions.failTest("NBTC082 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("NBTC082 ", "Executed Successfully");
			}
		}
	}
