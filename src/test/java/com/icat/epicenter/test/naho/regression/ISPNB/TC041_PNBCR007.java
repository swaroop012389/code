...
public class TC041_PNBCR007 extends AbstractNAHOTest {

	public TC041_PNBCR007() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBCR007.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Verifying the Mandatory field for Material Misrepresentation Reason
			for (int i = 0; i < 7; i++) {
				int dataValuei = i;
				...
				String mandatoryMsg = cancelPolicyPage.legalNoticeWordingMandatoryMsg.getData();
				Assertions.verify(cancelPolicyPage.legalNoticeWordingMandatoryMsg.checkIfElementIsDisplayed(), true,
						"Cancel Policy Page",
						"The error message " + mandatoryMsg + " displayed for the Reason  : " + cancelReason, false,
						false);
			}
			...
			Assertions.failTest("PNBTC041 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC041 ", "Executed Successfully");
			}
		}
	}
