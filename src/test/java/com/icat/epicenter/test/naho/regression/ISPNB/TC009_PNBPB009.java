...
public class TC009_PNBPB009 extends AbstractNAHOTest {

	public TC009_PNBPB009() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBPB009.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			// Assert effective date warning message
			Assertions.verify(
					endorsePolicyPage.effectiveDateWarningMsg.getData()
							.contains("The effective date has to be in the range"),
					true, "Endorse Summary Details Page", "Effective date warning message "
							+ endorsePolicyPage.effectiveDateWarningMsg.getData() + " is displayed",
					false, false);
