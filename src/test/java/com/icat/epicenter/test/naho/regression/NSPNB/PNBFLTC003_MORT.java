/** Program Description: Creating Moratorium for FL State,Deleting Moratorium and Verifying Moratorium Warning message
 *  Author			   : Pavan
...
public class PNBFLTC003_MORT extends AbstractNAHOTest {

	public PNBFLTC003_MORT() {
		super(LoginType.ADMIN);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/NSPNB/FL003.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			Assertions.failTest("PNBFLTC003 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBFLTC003 ", "Executed Successfully");
			}
		}
	}
}
