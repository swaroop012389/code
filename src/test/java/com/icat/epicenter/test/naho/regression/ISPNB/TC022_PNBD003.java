...
public class TC022_PNBD003 extends AbstractNAHOTest {

	public TC022_PNBD003() {
		super(LoginType.NAHOUSM);
	}

	@Override
	protected String getDataFilePath() {
		return "src/test/resources/testdata/naho/regression/ISPNB/PNBD003.xls";
	}
	...
	protected void execute(List<Map<String, String>> data, Map<String, String> setUpData) {
		...
		try {
			...
			String eqb = endorsePolicyPage.endorsementSummary.formatDynamicPath(5).getData();
			String eqbValue = endorsePolicyPage.endorsementSummary.formatDynamicPath(7).getData();
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(5).checkIfElementIsDisplayed(),
					true, "Endorse Summary Page", "The " + eqb + " entered is : " + eqbValue + " displayed is verified",
					false, false);

			String serviceLine = endorsePolicyPage.endorsementSummary.formatDynamicPath(10).getData();
			String serviceLineValue = endorsePolicyPage.endorsementSummary.formatDynamicPath(12).getData();
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(10).checkIfElementIsDisplayed(),
					...
					"The " + serviceLine + " entered is : " + serviceLineValue + " displayed is verified", false,
					false);

			String identityFraud = endorsePolicyPage.endorsementSummary.formatDynamicPath(17).getData();
			String identityFraudValue = endorsePolicyPage.endorsementSummary.formatDynamicPath(19).getData();
			Assertions.verify(endorsePolicyPage.endorsementSummary.formatDynamicPath(17).checkIfElementIsDisplayed(),
					true, "Endorse Summary Page",
					"The " + identityFraud + identityFraudValue + " displayed is verified", false, false);
			...
			Assertions.failTest("PNBTC022 ", "Test Failed " + e.getMessage());
		} finally {
			if (isTestPassed) {
				Assertions.passTest("PNBTC022 ", "Executed Successfully");
			}
		}
	}
